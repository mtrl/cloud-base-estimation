...
if __name__ == "__main__":
    ...
    min_temp = weatherunitstemp.fahrenheit_to_celsius(data["daily"]["data"][0]["temperatureMin"])
    print "Min forecast temperature for the day is {0}C".format(min_temp)
    max_temp = weatherunitstemp.fahrenheit_to_celsius(data["daily"]["data"][0]["temperatureMax"])
